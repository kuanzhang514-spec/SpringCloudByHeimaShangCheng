...
public class PayController {
    ...
    /**
     * 定义根据orderId查询支付单的接口，为了实现跨服务的openFeign远程调用
     */

    @ApiOperation("根据orderId查询支付单")
    @GetMapping("/biz/{id}")
    public PayOrderDTO queryByOrderId(@PathVariable("id") Long id) {
        return payOrderService.queryByOrderId(id);
    }
